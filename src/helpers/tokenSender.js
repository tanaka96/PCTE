...
var sendEmail = function (email, token) { return __awaiter(void 0, void 0, void 0, function () {
    var transporter, mailConfig;
    return __generator(this, function (_a) {
        ...
        mailConfig = {
            ...
            text: 'Seja bem-vindo à PCTE,\n' +
                ...
                "\n".concat(process.env.BASE_URL, "/verificacao/").concat(token, "\n") +
                '\nObrigado!'
        };
