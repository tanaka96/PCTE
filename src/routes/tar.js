...
tar.get("/", function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var tar;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, app_data_source_1.myDataSource.getRepository(tar_1.Tar).find()];
                case 1:
                    tar = _a.sent();
                    res.json(tar);
                    return [2 /*return*/];
...
tar.post("/", function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var tar, results;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, app_data_source_1.myDataSource.getRepository(tar_1.Tar).create(req.body)];
                case 1:
                    tar = _a.sent();
...
tar.delete("/:id", function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var results;
        return __generator(this, function (_a) {
            switch (_a.label) {
